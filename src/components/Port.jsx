...
const portText=[
  {
    ...
    img:port01,
    img_alt:"code_99팀",
    desc:"Lorem ipsum dolor, sit amet consectetur adipisicing elit. Asperiores provident minima animi laboriosam recusandae, iste similique dicta cumque, ducimus fugiat possimus corrupti repellat rerum ad ea nemo esse magni vitae.",
...
const Port = () => {
  ...
  // horizontalRef 변수를 생성하고, useRef훅으로 빈배열로 초기화
